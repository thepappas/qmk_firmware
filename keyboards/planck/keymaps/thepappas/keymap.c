...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[Nav] = LAYOUT_ortho_4x12(
        KC_TRNS,     KC_TAB,       KC_APP,     KC_BSPC,      KC_ENT,      KC_DEL, LSFT(KC_LEFT), LSFT(KC_DOWN), LSFT(KC_UP), LSFT(KC_RGHT), LSFT(KC_ENT), KC_TRNS,
    ...
    [Mouse] = LAYOUT_ortho_4x12(
        ...
        KC_TRNS, LCTL(KC_ENT), LCTL(KC_GRV),   RCS(KC_A),   RCS(KC_V),     KC_ESC,            KC_WH_L,       KC_WH_D,     KC_WH_U,       KC_WH_R,      KC_FIND, KC_RSFT,
	...
	[CTL] = LAYOUT_ortho_4x12(
        ...
        QK_BOOT, DB_TOGG, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),

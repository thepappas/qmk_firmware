...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //,------------------------------------------------------.                    ,-----------------------------------------------------.
    LT(3,KC_ESC),   KC_Q,   KC_W,   KC_E,      KC_R,    KC_T,                         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,  KC_QUOT,
    //|---------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
	...
	[1] = LAYOUT_split_3x6_3(
         KC_TRNS,   LGUI(KC_L),  LCA(KC_DEL), LCA(KC_END), LCA(KC_INS),    KC_PSCR,      LSFT(KC_LEFT), LSFT(KC_DOWN), LSFT(KC_UP), LSFT(KC_RGHT), LSFT(KC_ENT), KC_TRNS,
	...
	[2] = LAYOUT_split_3x6_3(
        KC_ESC, KC_PLUS, KC_7, KC_8, KC_9, KC_ASTR,        KC_APP,  KC_NUM, KC_SCRL,  KC_INS,  KC_DEL,   KC_NO,
        KC_GRV, KC_MINS, KC_4, KC_5, KC_6, KC_SLSH,       KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_TRNS,  KC_ENT,
        KC_ENT, KC_PCMM, KC_1, KC_2, KC_3, KC_EQL,        KC_PIPE, KC_BSLS, KC_UNDS, KC_TRNS, KC_TRNS, KC_TRNS,

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[Sym] = LAYOUT_split_3x6_3(
        KC_LCTL, KC_TILD, KC_AMPR, KC_ASTR, KC_PLUS,  KC_BSPC,     KC_NUM,  KC_APP,  KC_INS,  KC_DEL, KC_BSPC, KC_TRNS,
        KC_LALT, KC_MINS,  KC_DLR, KC_PERC, KC_CIRC,   KC_GRV,    KC_PMNS, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_TRNS,
